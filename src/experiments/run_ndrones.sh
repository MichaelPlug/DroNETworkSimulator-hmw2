...
python3 -m src.experiments.json_and_plot -nd 2 -nd 5 -nd 10 -nd 15 -nd 20 -nd 25 -nd 30 -nd 35 -nd 40 -i_s 1 -e_s 30 -exp_suffix MGEO -exp_suffix AISG_UP -exp_suffix GRID -exp_suffix GRID_W_NEXT_UP
